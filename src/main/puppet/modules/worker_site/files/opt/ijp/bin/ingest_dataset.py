...
if len(args) != 2: terminate("ingest.py must have 2 arguments: sessionId and input", 1) 
sessionId, input = args
...
# FIXME choose investigation more sensibly!
invs = session.search("Investigation")
if invs: investigation = invs[0]
